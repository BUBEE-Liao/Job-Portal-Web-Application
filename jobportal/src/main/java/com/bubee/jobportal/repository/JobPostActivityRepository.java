...
import com.bubee.jobportal.entity.IRecruiterJobs;
...
public interface JobPostActivityRepository extends JpaRepository<JobPostActivity, Integer> {
    ...
    // Retrieve list of jobs for a given recruiter id, also includes
    // a count of job seekers who have applied for a given job
    ...
    // when we use native query, return table won't be a specific class
    // it'll be part of one table, or joint of two table, etc
    // so we need to create a interface that can access this joint table
